...
public class FastYinChecker
{
     ...
     */
    private static readonly double DEFAULT_THRESHOLD = 0.03;//0.08;// 0.20;
     ...
     */
    public FastYinChecker(float audioSampleRate, int bufferSize)
     ...
     */
    public FastYinChecker(float audioSampleRate, int bufferSize, double yinThreshold)
    {
