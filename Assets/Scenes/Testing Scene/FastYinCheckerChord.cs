...
public class FastYinCheckerChord
{
     ...
     */
    private static readonly double DEFAULT_THRESHOLD = 0.06;//0.08;// 0.20;
     ...
     */
    public FastYinCheckerChord(float audioSampleRate, int bufferSize)
     ...
     */
    public FastYinCheckerChord(float audioSampleRate, int bufferSize, double yinThreshold)
    {
     ...
     */
    public void difference(float[] audioBuffer)
    {
