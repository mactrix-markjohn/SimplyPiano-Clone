...
public class Chordj : MonoBehaviour
{
    
    public  String root;
    public  String type;
    public  String[] ALL_ROOT_NOTES =new [] {"A","A#","B","C","C#","D","D#","E","F","G","G#"};
    public  String[] ALL_CHORD_TYPES = {"maj","m","maj7","m7","5","7","9","sus2","sus4","7sus4","7#9","add9","aug","dim","dim7"};
    ...
    public Chordj(String root, String type){
        //TODO: input handling
    ...
    private int noteNameToSemitoneNumber(String namez){
        String newName = namez;
        char[] name = namez.ToCharArray();
