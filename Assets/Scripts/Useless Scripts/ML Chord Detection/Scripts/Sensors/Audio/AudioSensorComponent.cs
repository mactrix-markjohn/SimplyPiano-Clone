...
namespace MBaske.Sensors.Audio
{
    ...
    public class AudioSensorComponent : SensorComponent, IAudioSampler
    {
        ...
        private void SampleSpectrumMono()
        {
            ...
            GetAudioSource.AudioSource.GetSpectrumData(m_SamplesL, 0, m_FFTWindow);
            GetAudioSource.AudioSource.GetSpectrumData(m_SamplesR, 1, m_FFTWindow);
        ...
        private void SampleAmplitudeMono()
        {
            ...
            GetAudioSource.AudioSource.GetOutputData(m_SamplesL, 0);
            GetAudioSource.AudioSource.GetOutputData(m_SamplesR, 1);
